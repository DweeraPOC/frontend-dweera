export const Pp = [
    ...
    },
    {
        ...
        context : {
            type : 'paragraph',
            body : [
                "En accédant à Dweera.ma, vous reconnaissez avoir pris connaissance des présentes informations et conditions générales d'utilisation, et reconnaissez les accepter. Il est de votre responsabilité de lire et de comprendre ces conditions, normes, politiques et exigences avant d’accéder et utiliser  Dweera.ma."
            ]
        }
    },
    {
        ...
        context : {
            ...
            body : [
                {
                    subtitle : "Annonceurs/utilisateurs",
                    body : [
                        "Les annonceurs/utilisateurs reconnaissent que le contenu publicitaire, y compris les textes, images, graphiques, vidéos ('Contenu') publié sur dweera.ma est exact et conforme aux lois en vigueur. Dweera.ma / Linarqa SARL n'assume aucune responsabilité quant à toute illicéité ou toute erreur relative aux annonces sur le site. L'annonceur/utilisateur convient que son contenu ne viole aucun droit d'auteur, droits de propriété intellectuelle ou d'autres droits de toute personne ou entité.",
                        "Votre relation avec Dweera.ma / Linarqa SARL est celle d'une entité ou d'un individu indépendant et non un salarié, agent, co-entrepreneur ou partenaire de Dweera.ma / Linarqa SARL. Dweera.ma/ Linarqa SARL ne dirige ni ne contrôle votre Service de location de véhicules. Vous comprenez que vous avez toute latitude pour décider si et quand vous souhaitez fournir des services de location de véhicules, et à quel prix et à quelles conditions les offrir."
                    ]
                },
                {
                    subtitle : "Voyageurs",
    ...
    {
        title : "Respect de la vie privée, collecte et traitement des données personnelles",
        context : {
            type : 'paragraph',
            body : [
    ...
    {
        title : "Droit d'accès et correction des données personnelles",
        context : {
            type : 'paragraph',
            body : [
